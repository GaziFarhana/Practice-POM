...
public static String readproperties(String key) throws IOException {
	...
	File f1=new File("/Users/gazifarhana/eclipse-workspace1/GrateCourse/Locator.Properties");
...
public static String readexcel(WebDriver driver, int rownum, int colnum) throws IOException {
	...
	File fl = new File("/Users/gazifarhana/eclipse-workspace1/GrateCourse/GC.xlsx");
