...
public class BillingAddress extends Lib{
	...
	public static void address1(WebDriver driver) throws IOException, InterruptedException {
		WebElement address=findelement(driver,readproperties("add1"));
	...
	public static void address2(WebDriver driver) throws IOException, InterruptedException {
		WebElement address=findelement(driver,readproperties("add2"));
	...
	public static void confirmpassword(WebDriver driver) throws IOException, InterruptedException {
		WebElement password=findelement(driver,readproperties("confirmpass"));
		password.sendKeys(readexcel(driver,7,0));
		Thread.sleep(2000);
	}
public static void shipping(WebDriver driver) throws IOException {
	...
	public static void clickContinue (WebDriver driver) throws IOException, InterruptedException {
		WebElement cont=findelement(driver,readproperties("cont"));
		cont.click();
	Thread.sleep(2000);
}
}
